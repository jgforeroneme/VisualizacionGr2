...
<!-- Aca suba vainas -->
  ...
  <div class="w3-black" id="portfolio">
    <div class="w3-row w3-padding-32">
      ...
      <div class="w3-third">
        <h3 style="text-align:center;">Introducción a la estadistica descriptiva multivariada - II</h3>
        <div align="center"><a href="cuadernos/Intro_Multi2.ipynb"><img src="https://raw.githubusercontent.com/madcentral/metodosestadisticos/master/images/imagen1.png" class="w3-round w3-margin-bottom" alt="Random Name" style="width:60%;"></a>
        </div>
      </div>
      <div class="w3-third">
        <h3 style="text-align:center;">Análisis de componentes principales</h3>
        <div align="center"><a href="https://github.com/madcentral/metodosestadisticos/blob/master/cuadernos/2_ACP (4).ipynb"><img src="https://raw.githubusercontent.com/madcentral/metodosestadisticos/master/images/ACP.png" class="w3-round w3-margin-bottom" alt="Random Name" style="width:60%;"></a>
        </div>
      </div>     
  </div>
  </div>
  <!-- Evidencias -->
  <div class="w3-white" id="portfolio">
    <div class="w3-row w3-padding-32">
      <div class="w3-third">
        <h3 style="text-align:center;">Introducción a la estadistica descriptiva multivariada</h3>
